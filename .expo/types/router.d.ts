...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(auth)/login` | `/login` | `/(auth)/register` | `/register` | `/(auth)/welcome` | `/welcome` | `/(tabs)/home` | `/home` | `/(tabs)/library` | `/library` | `/(tabs)/profile` | `/profile` | `/(tabs)/upload` | `/upload` | `/payment/checkout` | `/payment/plans`;
  // prettier-ignore
  type DynamicRoutes<T extends string> = `/circuit/${SingleRoutePart<T>}` | `/quiz/${SingleRoutePart<T>}` | `/quiz/results/${SingleRoutePart<T>}`;
  // prettier-ignore
  type DynamicRouteTemplate = `/circuit/[id]` | `/quiz/[id]` | `/quiz/results/[id]`;
